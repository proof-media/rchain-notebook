  ...
  """
    ...
    """
        self.DoDeploy = channel.unary_unary(
            ...
            response_deserializer=CasperMessage__pb2.DeployServiceResponse.
            FromString,
        )
        self.addBlock = channel.unary_unary(
            '/coop.rchain.casper.protocol.DeployService/addBlock',
            request_serializer=CasperMessage__pb2.BlockMessage.
            SerializeToString,
            response_deserializer=CasperMessage__pb2.DeployServiceResponse.
            FromString,
        )
        ...
        self.showBlock = channel.unary_unary(
            ...
            response_deserializer=CasperMessage__pb2.BlockQueryResponse.
            FromString,
        )
        ...
        self.listenForDataAtName = channel.unary_unary(
            ...
            response_deserializer=CasperMessage__pb2.ListeningNameDataResponse.
            FromString,
        )
        self.listenForContinuationAtName = channel.unary_unary(
            ...
            response_deserializer=CasperMessage__pb2.
            ListeningNameContinuationResponse.FromString,
        )
...
def add_DeployServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        grpc.unary_unary_rpc_method_handler(
            ...
            response_serializer=CasperMessage__pb2.DeployServiceResponse.
            SerializeToString,
        ),
        'addBlock':
        grpc.unary_unary_rpc_method_handler(
        ...
        grpc.unary_unary_rpc_method_handler(
            ...
            response_serializer=CasperMessage__pb2.BlockQueryResponse.
            SerializeToString,
        ),
        'showBlocks':
        ...
        grpc.unary_unary_rpc_method_handler(
            ...
            response_serializer=CasperMessage__pb2.ListeningNameDataResponse.
            SerializeToString,
        ),
        ...
        grpc.unary_unary_rpc_method_handler(
            ...
            response_serializer=CasperMessage__pb2.
            ListeningNameContinuationResponse.SerializeToString,
        ),
    }

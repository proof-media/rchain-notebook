...
_CMDREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='line',
            full_name='coop.rchain.node.model.CmdRequest.line',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_EVALREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='program',
            full_name='coop.rchain.node.model.EvalRequest.program',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_REPLRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='output',
            full_name='coop.rchain.node.model.ReplResponse.output',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
CmdRequest = _reflection.GeneratedProtocolMessageType(
    'CmdRequest',
    (_message.Message, ),
    dict(
...
ReplResponse = _reflection.GeneratedProtocolMessageType(
    'ReplResponse',
    (_message.Message, ),
    dict(
